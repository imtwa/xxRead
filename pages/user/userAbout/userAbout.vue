    ...
    <view class="container">
      ...
      <view class="bottom">
        ...
        <view
          ...
          :class="[
            'view_tupian_wenzi',
            { view_active: item.title === version },
          ]"
        >
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          time: "2023-09-18",
          description:
            "优化榜单界面，解决遇到连续英文翻页阅读页面显示不完全的BUG",
        },
        {
          title: "1.0.8",
          time: "2023-09-21",
        ...
        },
        {
          ...
          time: "2023-11-11",
          description:
            "新增书源管理，使用并发处理，优化数据加载速度和系统性能，优化少量BUG",
        },
        {
          title: "2.0.6",
          time: "2024-3-4",
          description:
            "支持音量长按翻页，使用虚拟列表，优化主页目录加载速度，优化少量BUG",
        },
        {
          title: "2.0.8",
          time: "2024-4-4",
        ...
        },
        {
          ...
          time: "2024-8-25",
          description:
            "搜索页面精确展示搜索结果，加入搜索超时取消逻辑，优化少量BUG",
        },
      ],
    };
  },
