...
<template>
	<view style="height: 100vh;">
		...
		<view class="cover container"
			...
			:style="{
				zIndex: 201, transform: `translate${cover.pageTranslate[turnType]}`, transition: `transform ${showAnimation ? turnPageTime : 0}s`,
		...
		<view class="container"
			:class="{ container0: background === 1, container1: background === 2, container2: background === 3 }"
			:style="{
				zIndex: 102, transform: `translate${prePage.pageTranslate[turnType]}`, transition: `transform ${showAnimation ? turnPageTime : 0}s`,
				boxShadow: showShadow && turnType === 0 ? '0 0 10px 0 rgba(0,0,0,.4)' : ''
			}">
			<!-- 章节名 -->
			<view class="chapter">
			...
			<view class="content">
				...
				<view class="inner-box" :style="{ height: `${innerHeight}px` }" v-if="prePage.canRead">
					...
					<view class="book-inner" v-html="prePage.text" :style="{
						fontSize: `${fontSize}px`, lineHeight: `${lineHeight * fontSize}px`, color: `${colorList[background - 1]}`,
		...
		<view class="container"
			:class="{ container0: background === 1, container1: background === 2, container2: background === 3 }"
			:style="{
				zIndex: 101, transform: `translate${curPage.pageTranslate[turnType]}`, transition: `transform ${showAnimation ? turnPageTime : 0}s`,
				boxShadow: showShadow && turnType === 0 ? '0 0 10px 0 rgba(0,0,0,.4)' : ''
		...
		<view class="container"
			:class="{ container0: background === 1, container1: background === 2, container2: background === 3 }"
			:style="{
				zIndex: 100, transform: `translate${nextPage.pageTranslate[turnType]}`, transition: `transform ${showAnimation ? turnPageTime : 0}s`,
				boxShadow: showShadow && turnType === 0 ? '0 0 10px 0 rgba(0,0,0,.4)' : ''
			}">
			<!-- 章节名 -->
			<view class="chapter">
