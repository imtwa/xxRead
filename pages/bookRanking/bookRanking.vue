<template>
	<view class="container">
		<view class="tab">
			<u-tabs :current="index" :list="list" lineWidth="30" lineColor="#f56c6c" :activeStyle="{
			            color: '#303133',
			            fontWeight: 'bold',
