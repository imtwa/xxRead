...
XPathParser.prototype.init = function () {
  ...
  this.reduceActions[28] = function (rhs) {
    ...
    rhs[0].locationPath.steps.unshift(
      new Step(Step.DESCENDANTORSELF, new NodeTest(NodeTest.NODE, undefined), [])
    )
    return rhs[0]
  }
    ...
    for (var i = 0; i < this.locationPath.steps.length; i++) {
        ...
        switch (step.axis) {
          ...
          case Step.ANCESTORORSELF:
            ...
            for (
              ...
              m != null;
              m = m.nodeType == 2 /*Node.ATTRIBUTE_NODE*/ ? this.getOwnerElement(m) : m.parentNode
            ) {
              if (step.nodeTest.matches(m, xpc)) {
                newNodes.push(m)
              }
      ...
      for (var j = 0; j < step.predicates.length; j++) {
        ...
        for (
          ...
          var localCtx =
            newLocalContext.length > 0
              ? this.getLocalCtx(xpc, newLocalContext[xpc.contextPosition - 1])
              : xpc
    ...
    case NodeTest.NAMETESTQNAME:
      if (
        ...
        if (xpc.caseInsensitive) {
          return (
            test[0] == node[0] && String(test[1]).toLowerCase() == String(node[1]).toLowerCase()
          )
        }
...
Functions.id = function () {
  ...
  var ns = new XNodeSet()
  var doc =
    c.contextNode.nodeType == 9 /*Node.DOCUMENT_NODE*/ ? c.contextNode : c.contextNode.ownerDocument
