	...
	<view class="container">
		<view class="upper-section">
			<view class="left-section">
				<BookList :imgurl="spopupbook.imgurl" :title="spopupbook.bookname" :isClick="true"
					:info="getInfo(spopupbook)" :info1="getInfo1(spopupbook)"
					:bookSourceName="spopupbook.bookSourceName"
					:tags="spopupbook.tags">
				</BookList>
			</view>
			<view class="right-section-wrapper">
				<u-button text="详情" type="error" shape="circle" size="normal" plain @click="goBookHome()"></u-button>
			</view>
		</view>
