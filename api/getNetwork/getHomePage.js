...
const getHomePage = {
  ...
  homePage2: async bookurl => {
    ...
    try {
      ...
      // 获取目录
      const list = new HTMLParser(doc.getElementsByClassName('section-box')[1]['innerHTML'])
      const dds = list.getElementsByTagName('li')
      let chapter = []
  ...
  homePage9: async bookurl => {
    ...
    try {
      ...
      // 获取目录
      const list = new HTMLParser(doc.getElementsByClassName('panel-chapterlist')[0]['innerHTML'])
  ...
  homePage10: async bookurl => {
    ...
    try {
      ...
      // 获取目录
      const list = new HTMLParser(doc.getElementById('booklistBox')['innerHTML'])
      const dds = list.getElementsByTagName('li')
      let chapter = []
  ...
  homePage11: async bookurl => {
    ...
    try {
      ...
      const urllist = new HTMLParser(
        urldoc.getElementById('indexselect').innerHTML
  ...
  homePage12: async bookurl => {
    ...
    try {
      ...
      const intro = new HTMLParser(
        doc.getElementsByClassName('lb_jj')[0].innerHTML
